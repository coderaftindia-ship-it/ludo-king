...
// Mode types
type Mode = "classic" | "rush" | "bolt" | "dash";
type TokenColor = "blue" | "red" | "green" | "yellow";
type PlayersTab = "solo" | "2vs2";

export default function FriendsScreen() {
  const [activeTab, setActiveTab] = useState<PlayersTab>("solo");
  ...
  const handleTabChange = (tab: PlayersTab) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        {/* Segmented Controller (Solo / 2 vs 2) */}
        <View style={styles.tabContainer}>
          <View style={styles.tabTrack}>
            <TouchableOpacity
              ...
              style={[
                styles.tabButton,
                activeTab === "solo" && styles.tabButtonActive,
              ]}
            >
              {activeTab === "solo" ? (
                <LinearGradient
                ...
                >
                  <Text style={styles.tabTextActive}>Solo</Text>
                  <View style={styles.checkCircle}>
                    <Ionicons name="checkmark" size={10} color="#3de84a" />
                  </View>
                </LinearGradient>
              ) : (
                <Text style={styles.tabTextInactive}>Solo</Text>
              )}
            </TouchableOpacity>

            <TouchableOpacity
              activeOpacity={0.9}
              onPress={() => handleTabChange("2vs2")}
              style={[
                styles.tabButton,
                activeTab === "2vs2" && styles.tabButtonActive,
              ]}
            >
              {activeTab === "2vs2" ? (
                <LinearGradient
                  ...
                  style={styles.activeTabGradient}
                >
                  <Text style={styles.tabTextActive}>2 vs 2</Text>
                  <View style={styles.checkCircle}>
                    <Ionicons name="checkmark" size={10} color="#3de84a" />
                  </View>
                </LinearGradient>
              ) : (
                <Text style={styles.tabTextInactive}>2 vs 2</Text>
              )}
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.modesContainer}>
          ...
          >
            <LinearGradient
              ...
              style={[
                styles.modeCircle,
                selectedMode === "dash" && styles.modeCircleSelected,
              ]}
            >
              <FontAwesome5
                name="flag-checkered"
                size={20}
                color={selectedMode === "dash" ? "#fff" : "#7d5d42"}
              />
            </LinearGradient>
            <Text style={[styles.modeText, selectedMode === "dash" && styles.modeTextSelected]}>Dash</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.rewardsCard}>
          ...
          <View style={styles.rewardsContent}>
            <Text style={styles.winnerTakesAllText}>Winner takes all</Text>
            <Text style={styles.rewardsSubText}>Beat your friend to win big!</Text>
          </View>
        </View>
        ...
        <View style={styles.actionContainer}>
          ...
          <View style={styles.tooltipContainer}>
            ...
            <View style={styles.tooltipContent}>
              <Text style={styles.tooltipText}>Max entry enabled!</Text>
            </View>
          </View>
          ...
          <View style={styles.startRow}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                alert("Room created! Table code: 948194");
              }}
